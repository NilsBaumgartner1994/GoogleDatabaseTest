...
public class EasyFrameFX implements EasyFrameInterface {
    ...
    public GridPane addGridPane() {
        ...
        ImageView imageHouse = new ImageView(
          new Image(LayoutStyle.class.getResourceAsStream(pathToGrapthis+"house.png")));
        ...
        ImageView imageChart = new ImageView(
         new Image(LayoutStyle.class.getResourceAsStream(pathToGrapthis+"piechart.png")));
    ...
    public FlowPane addFlowPane() {
        ...
        for (int i=0; i<8; i++) {
            pages[i] = new ImageView(
                new Image(LayoutStyle.class.getResourceAsStream(
                		pathToGrapthis+"chart_"+(i+1)+".png")));
